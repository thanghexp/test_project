 ...
 */
//require_once dirname(__FILE__) . '/../../tecnickcom/tcpdf/tcpdf.php';
//require_once dirname(__FILE__) . '/../../fpdf/fpdf.php';

if (!class_exists('Illuminate\third_party\tecnickcom\tcpdf\TCPDF', false)) {
    /**
     * Class fpdi_bridge
     */
     ...
     * Class fpdi_bridge
     */
    class fpdi_bridge extends Illuminate\third_party\tecnickcom\tcpdf\TCPDF
    {
        /**
         * Array of Tpl-Data
         *
