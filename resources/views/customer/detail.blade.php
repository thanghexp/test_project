        ...
        <div class="box box-primary">
            <div class="box-body box-profile">
                <h3 class="profile-username text-center">
                    ...
                    <p><!--{$data_customer.name|escape|default:''}--></p>
                </h3>
                <ul class="list-group list-group-unbordered">
                    <li class="list-group-item">
                        <i class="fa fa-check-circle margin-r-5 text-primary"></i>ステータス
                        <span class="pull-right"><small class="label label-success"><!--{$data_customer.status_name|escape|default:''}--></small></span>
                    </li>
                    <li class="list-group-item">
                        <i class="fa fa-cogs margin-r-5 text-primary"></i>取引先種別
                        <!--{assign var=type value=$data_customer.data_types|array_column:type_name}-->
                        <span class="pull-right"><!--{implode(", ", $type)}--></span>
                    </li>
                    <li class="list-group-item">
                        <i class="fa fa-codepen margin-r-5 text-primary"></i>郵便番号
                        <span class="pull-right"><!--{$data_customer.postal_code|escape|default:''}--></span>
                    </li>
                    <li class="list-group-item">
                        <i class="fa fa-map-marker margin-r-5 text-primary"></i>住所
                        <span class="pull-right"><!--{$data_customer.address|escape|default:''}--></span>
                    </li>
                    <li class="list-group-item">
                        <i class="fa fa-phone-square margin-r-5 text-primary"></i>電話番号
                        <span class="pull-right"><!--{phone_number tel=$data_customer.phone_number|escape}--></span>
                    </li>
                    <li class="list-group-item">
                        <i class="fa fa-fax margin-r-5 text-primary"></i>FAX番号
                        <span class="pull-right"><!--{phone_number tel=$data_customer.fax_number|escape}--></span>
                    </li>
                    <li class="list-group-item">
                        <i class="fa fa-calendar margin-r-5 text-primary"></i>支払請求種別
                        <span class="pull-right"><!--{$data_customer.bill_type_name|escape|default:''}--></span>
                    </li>
                    <li class="list-group-item">
                        <i class="fa fa-user margin-r-5 text-primary"></i>主担当者名
                        <span class="pull-right"><!--{customer_contact name=$data_customer.main_charge_name|escape|default:'' contact=$data_customer.main_charge_contact|escape|default:''}--></span>
                    </li>
                    <li class="list-group-item">
                        <i class="fa fa-user margin-r-5 text-primary"></i>副担当者名
                        <span class="pull-right"><!--{customer_contact name=$data_customer.extra_charge_name|escape|default:'' contact=$data_customer.extra_charge_contact|escape|default:''}--></span>
                    </li>
                    <li class="list-group-item">
                        <i class="fa fa-file-text margin-r-5 text-primary"></i>備考
                        <p><!--{$data_customer.remark|escape|nl2br|default:''}--></p>
                    </li>
                </ul>
            </div>
